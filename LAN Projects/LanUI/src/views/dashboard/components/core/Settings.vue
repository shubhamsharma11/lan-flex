<template>
  <div id="settings-wrapper">
    <v-card
      ...
      link
      min-width="100"
      style="position: fixed; bottom: 20px; right: -40px; border-radius: 8px;"
    >
      <v-icon
  ...
  export default {
    ...
    watch: {
      color (val) {
        ...
        this.$vuetify.theme.themes[this.$vuetify.theme.dark ? 'dark' : 'light'].secondary = val + ' ' + 'lighten-2'
      },
      showImg (val) {
        if (!val) {
