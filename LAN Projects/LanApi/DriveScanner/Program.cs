...
namespace DriveScanner
{
    class Program
    {
        ...
        public static string path = @"D:\Projects";
        ...
        private static void InsertData()
        {
            ...
            try
            {
                ...
                {
                    StringBuilder sCommand = new StringBuilder(@"INSERT INTO filesdetails (Name, Path, Extension, Size, LastUpdatedAt, CreatedAt) VALUES ");
                    ...
                    foreach (var fileInfo in FilesInfo)
                    {
                        ...
                        Rows.Add(string.Format(@"('{0}', '{1}', '{2}', {3}, '{4}', '{5}')", fileInfo.Name,
                            MySqlHelper.EscapeString(fileInfo.FullName), fileInfo.Extension, fileInfo.Length,
                            fileInfo.LastWriteTime.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss"),
                            fileInfo.CreationTime.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss")));
                    }
